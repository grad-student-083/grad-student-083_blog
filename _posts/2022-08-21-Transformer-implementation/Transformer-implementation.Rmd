...
$$\mathbf{M}_{\mathbf{x}\mathbf{z}} = \begin{bmatrix} \text{Mask}[\mathbf{x}_0, \mathbf{z}_0] & \text{Mask}[\mathbf{x}_0, \mathbf{z}_1]&  \text{Mask}[\mathbf{x}_0, \mathbf{z}_2] & \dots & \text{Mask}[\mathbf{x}_0, \mathbf{z}_{l_z-1}] & \text{Mask}[\mathbf{x}_0, \mathbf{z}_{l_z}]  \\ 
\text{Mask}[\mathbf{x}_1, \mathbf{z}_0] & \text{Mask}[\mathbf{x}_1, \mathbf{z}_1]&  \text{Mask}[\mathbf{x}_1, \mathbf{z}_2] & \dots & \text{Mask}[\mathbf{x}_1, \mathbf{z}_{l_z-1}] & \text{Mask}[\mathbf{x}_1, \mathbf{z}_{l_z}] \\
\vdots & \vdots&  \vdots & \dots & \vdots & \vdots \\ 
\text{Mask}[\mathbf{x}_{l_x}, \mathbf{z}_0] & \text{Mask}[\mathbf{x}_{l_x}, \mathbf{z}_1]&  \text{Mask}[\mathbf{x}_{l_x}, \mathbf{z}_2] & \dots & \text{Mask}[\mathbf{x}_{l_x}, \mathbf{z}_{l_z-1}] & \text{Mask}[\mathbf{x}_{l_x}, \mathbf{z}_{l_z}]
\end{bmatrix} \in \mathbb{R}^{l_x \times l_x}$$
...
$$\mathbf{M}_{\mathbf{x}\mathbf{z}} = \begin{bmatrix} 1& 1&  1 & \dots & 1 & 1  \\ 
1& 1&  1 & \dots & 1 & 1  \\ 
\vdots & \vdots&  \vdots & \dots & \vdots & \vdots \\ 
1& 1&  1 & \dots & 1 & 1
\end{bmatrix} \in \mathbb{R}^{l_x \times l_x}$$
...
$$\mathbf{M}_{\mathbf{x}\mathbf{z}} = \begin{bmatrix} 1& 0&  0 & \dots & 0 & 0  \\ 
1& 1&  0 & \dots & 0 & 0  \\ 
\vdots & \vdots&  \vdots & \dots & \vdots & \vdots \\ 
1& 1&  1 & \dots & 1 & 1
\end{bmatrix} \in \mathbb{R}^{l_x \times l_x}$$
...
| Algorithm 2: Multihead attention|
| :---      |
| input: $\mathbf{q} \in \mathbb{R}^{l_x \times d_k}, \mathbf{k} \in \mathbb{R}^{l_z\times d_k}, \mathbf{v} \in \mathbb{R}^{l_z\times d_v}, \mathbf{M}_{xz} \in \{0, 1\}^{l_x\times l_z}: \text{Optional}$|
...
|2 $\quad \mathbf{Z} \leftarrow \mathbf{Z} + \text{MultiheadAttention}(query=\mathbf{Z}, key=\mathbf{Z}, value=\mathbf{Z}, \mathbf{M}_{zz}))$ |
